...
public class Admin_homeTest {
    ...
    @Rule
    public ActivityTestRule<Admin_home> adminHomeTest = new ActivityTestRule<>(Admin_home.class);
    ...
    public void setUp() throws Exception {
        adminHome = adminHomeTest.getActivity();
    }

    @Test
    public void TestLaunchOfAdminProductsActivityOnButtonClick(){

        assertNotNull(adminHome.findViewById(R.id.btnProducts));
    ...
    public void TestLaunchOfAdminOrdersActivityOnButtonClick(){
        ...
        assertNotNull(adminHome.findViewById(R.id.btnOrders));
    ...
    public void TestLaunchOfAdminHomeActivityOnButtonClick(){
        ...
        assertNotNull(adminHome.findViewById(R.id.btnHome));
