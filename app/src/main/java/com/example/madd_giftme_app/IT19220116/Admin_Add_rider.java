...
public class Admin_Add_rider extends AppCompatActivity {
    ...
    private void validateProductData() {
        ...
        else if(TextUtils.isEmpty(rider_phone) || TextUtils.getTrimmedLength(rider_phone)!=10){
            Toast.makeText(getApplicationContext(),"Number should be 10 digits",Toast.LENGTH_LONG).show();
        ...
        dataReff.child(id).setValue(rider).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                if(task.isSuccessful()){
                    ...
                    Toast.makeText(getApplicationContext(),"Rider Added successfully",Toast.LENGTH_LONG).show();
