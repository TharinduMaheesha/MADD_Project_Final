...
public class CartFragment extends Fragment {
    ...
    private CartViewModel cartViewModel;
        ...
        Double oneTypeProductTotalPrice;
        ...
        public void onStart() {
            ...
            FirebaseRecyclerAdapter<AddProducts, AddProductsViewHolder> adapter
                ...
                protected void onBindViewHolder(@NonNull AddProductsViewHolder holder, int position, @NonNull final AddProducts model) {
                    ...
                    oneTypeProductTotalPrice = ((Double.valueOf(model.getPrice()))) * Double.valueOf(model.getQuantity()) ;
                            ...
                            builder.setItems(options, new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    ...
                                    if(i == 0){
                                        ...
                                        ViewProductDetails adminProductsFragment = new ViewProductDetails();
                                        Bundle bundle = new Bundle();
                                        bundle.putString("pid", model.getPid());
                                        bundle.putString("price", model.getPrice());
                                        adminProductsFragment.setArguments(bundle);
                                        FragmentManager manager = getFragmentManager();
                                        manager.beginTransaction().replace(R.id.nav_host_fragment, adminProductsFragment).addToBackStack(null).commit();
            ...
            orderRef.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    if(dataSnapshot.exists()){
                        ...
                        else if(shippingState.equalsIgnoreCase("Pending")){
